...
const ClientGallery = () => {
  ...
  if (eroare) return (
    <div style={{ textAlign: 'center', padding: '100px', fontFamily: 'sans-serif' }}>
      <h1>Oops!</h1>
      <p>{eroare}</p>
      <button onClick={() => window.location.reload()} style={{ padding: '10px 20px', cursor: 'pointer' }}>Reîncearcă</button>
    </div>
  );
  ...
  // Imaginea de cover: fie cea aleasă în Dashboard, fie prima din galerie
