    ...
    <div className="fl">
        ...
        <section id="despre" className="fl-despre">
          <div className="fl-despre-inner">
            <div className="fl-reveal">
              <p className="fl-despre-label">Despre Fotolio</p>
              ...
              <p className="fl-despre-text" style={{ marginTop: '20px' }}>
                Credem că fotograful trebuie să fie prezent la eveniment, alături de oaspeți — nu blocat în fața monitorului gestionând stocări nesigure. Am construit Fotolio pentru a fi rapid, intuitiv și invizibil.
              </p>
              <p className="fl-despre-text" style={{ marginTop: '20px' }}>
      ...
      <footer className="fl-footer">
        <div className="fl-footer-top">
          <div>
            <div className="fl-footer-logo">Fotolio</div>
        ...
        <div className="fl-footer-bottom">
          <span className="fl-footer-copy">© 2025 Fotolio. Toate drepturile rezervate.</span>
